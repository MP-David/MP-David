# Olá, eu sou o David Marlon! 👋

**`Desenvolvedor Fullstack | Mobile Engineer`**

Sou um desenvolvedor de software focado em criar soluções eficientes, arquiteturas limpas e experiências móveis modernas. 

### 👨‍💻 Sobre mim

- 🎓 Estudante de **Engenharia de Software** na UTFPR (Previsão de formação: 2026).
- 💼 Atualmente atuando como Desenvolvedor de Software, liderando refatorações e migrações de sistemas legados para arquiteturas modernas no ecossistema Android.
- 🔬 Meu foco técnico atual envolve **Kotlin, Jetpack Compose, Coroutines e Clean Architecture**.
- 📚 Pesquisando ativamente sobre concorrência e interoperabilidade entre modelos Java e Kotlin.
- 🌍 Português (Nativo) | Inglês (Avançado).
- 🚀 Sempre em busca de novos desafios técnicos e com planos de expandir minha carreira para o mercado internacional.
